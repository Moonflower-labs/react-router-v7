...
export default function HelpPage() {
  ...
  const filteredQuestions = searchTerm ? questions.filter(q => q.question.toLowerCase().includes(searchTerm.toLowerCase())) : questions;
  ...
  return (
    <div className="mx-2 mb-4">
      ...
      <label className="input input-bordered input-sm mb-4 flex items-center gap-2 max-w-sm mx-auto">
        <input type="text" className="grow" placeholder="Search" onChange={e => setSearchTerm(e.currentTarget.value)} />
...
const questions = [
  {
    ...
    answer: " No escogiste ninguno de los tres planes de suscripción aunque sea el gratuito que es el Plan Personalidad."
  },
  {
    id: 2,
  ...
  {
    id: 3,
    question: " ¿Porqué no consigo entrar en la sección Personalidad? 😔",
    answer: " Necesitas suscribirte al plan Personalidad, que es gratuito, para tener acceso a formular tus preguntas y al contenido. "
  },
  {
    id: 4,
  ...
  },
  {
    ...
    answer: " Necesitas estar suscrito al Plan Espíritu. Este servicio es exclusivo de este plan."
  },
  {
    id: 6,
    question: " ¿Porqué no consigo entrar en las secciones de Alma o Espíritu? 😔",
    answer: " Necesitas suscribirte a estos planes Alma o Espíritu, que son de pago, para acceder a los servicios y beneficios que te ofrecen."
  },
  {
    id: 7,
    question: " ¿Cómo cambio mi dirección y datos personales? 🤔",
    answer:
      "Debes entrar en el Portal del Cliente en Inicio o en la sección Ayuda. Esto te redireccionará a Stripe, a nuestro sistema de pago y allí podrás modificar todos tus datos personales."
  },
  {
    id: 8,
  ...
  },
  {
    ...
    answer: " No. Si no usas las Preguntas disponibles en el mes en vigor se pierden. Pero se renuevan al mes siguiente, el primer día de cada mes."
  },
  {
    id: 11,
    question: "¿Cuánto tiempo se tarda en recibir las respuestas? 😃",
    answer: "Depende de por cual via se responda: por escrito entre 24 y 48 horas. Por audio entre 48 y 72 horas, por video entre 3 a 5 días aproximadamente."
  },
  {
    id: 12,
  ...
  },
  {
    ...
    answer:
      " Si el compartir es tu don serás recompensado por tu dedicación obteniendo una de las tres opciones: una pregunta de Tarot gratuita, acceso a un Directo gratuito o acceso a un episodio gratuito de tu interés de los disponibles en la Tienda por cada miembro que se suscriba por tu parte a los Planes de Alma o Espíritu.\n Si consigues un miembro para el plan Espíritu la bonificación o bonus es libre albedrío. Puedes escoger una opción cualquiera de entre las tres opciones gratuitas: una Pregunta de Tarot, acceso a un Directo o acceso a un episodio de tu interés en la Tienda. Hay trailers de los episodios en Lista de Podcast.\n Si consigues un miembro para el plan Alma la bonificación o el bonus sería: una pregunta de Tarot gratuita o acceso a un episodio gratuito de tu interés en la Tienda. Hay trailers de los episodios en Lista de Podcast.\n Si consigues tres miembros para el Plan Espíritu, tu bonificación sería acceso a un episodio gratuito de tu interés, más una pregunta de Tarot gratuita, más acceso a un Directo (si ya tienes acceso al directo se te puede canjear por dos episodios gratuitos de tu interés de la Tienda; que harían un total de tres episodios gratuitos más una pregunta de Tarot gratuita de bonificación o bonus). Hay trailers de los episodios en Lista de Podcast.\nSi consigues tres miembros para el Plan Alma tu bonificación o bonus lo puedes canjear por acceso a una session en Directo gratuita."
  }
];
