...
//       {hasRated ? (
//         <motion.div key={"rated"} {...animationProperties}>
//           <div className="border rounded-lg p-2 shadow">Ya has valorado esta respuesta 👍</div>
//         </motion.div>
//       ) : (
//         <motion.div key={"rating"} {...animationProperties}>
//           <Form method="post" className="flex flex-col items-center">
...
//                   <GiHeraldicSun
//                     size={35}
//                     className={`transition-colors duration-300 ease-in-out tranform ${
//                       rate <= (hoverRating || rating) ? "text-yellow-400" : "text-gray-400"
...
//             <button type="submit" className="btn btn-primary transition-all duration-200 ease-in-out transform hover:scale-105" disabled={rating === 0}>
//               Submit Rating
//             </button>
//           </Form>
//         </motion.div>
