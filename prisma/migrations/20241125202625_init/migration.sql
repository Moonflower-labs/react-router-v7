-- CreateEnum
CREATE TYPE "Section" AS ENUM ('Spirit', 'Soul', 'Live');
...
CREATE TABLE "PremiumQuestion" (
    ...
    CONSTRAINT "PremiumQuestion_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "PremiumQuestion" ADD CONSTRAINT "PremiumQuestion_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
